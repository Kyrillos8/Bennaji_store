...
def categories():
    ...
    items_li = ""
    for i in items:
        items_li += """<li><a href="/category/{}" style="color: white;">{}</a></li>""".format(i.slug, i.title)
...
def categories_mobile():
    ...
    items_li = ""
    for i in items:
        items_li += """<li class="item-menu-mobile"><a href="/category/{}" style="color: white;">{}</a></li>""".format(i.slug, i.title)
    return mark_safe(items_li)
...
def categories_li_a():
    ...
    items_li_a = ""
    for i in items:
        items_li_a += """<li class="p-t-4"><a href="/category/{}" class="s-text13" style="color: white;">{}</a></li>""".format(i.slug,
                                                                                                         i.title)
